...
import SwiperCore from "swiper"; // Importa SwiperCore para la instancia
import "swiper/css";
...
const projects = [
  {
    num: "01",
    category: "Planificador de Gastos ",
    title: "",
    description:
      "Permite definir un presupuesto, realizar seguimiento de gastos, ademas tambien podemos actualizar y eliminar gastos.",
    stack: [
      { name: "React" },
      { name: "Tailwind CSS" },
      { name: "TypeScript" },
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          >
            <div className="flex flex-col gap-[30px] h-[50%]">
              ...
              {/* project category */}
              <h2
                className="text-[42px] font-bold leadind-none text-white
